...
An Angular CLI web application, stnpublicinfo is an application accessed via the Flood Event Viewer (FEV), to show Site, Site Peaks, HWM or Sensor, and HWM/Sensor Files based on the HWM/Sensor chosen.
